...
extension L10n.Key {
    ...
    static let createGroup = Self(zh: "创建新分组", en: "Create New")
    static let useExistingGroup = Self(zh: "使用现有分组", en: "Use Existing")
    static let selectGroup = Self(zh: "选择分组", en: "Select Group")
    static let filterGroups = Self(zh: "过滤分组...", en: "Filter groups...")
    static let noMatchingGroups = Self(zh: "没有匹配的分组", en: "No matching groups")
